...
<body>
  <header class="top"><div class="wrap"><a class="brand" href="../../"><img src="../../explained_meme_logo_transparent.png" alt="Explained Meme"></a><nav aria-label="Main navigation"><a href="../../">EXPLAINED</a><a href="../../meme-radar.html">MEME RADAR</a><a href="../../meme-generator.html">MEME GENERATOR</a><a href="../">ALL MEMES</a></nav></div></header>
  <main class="wrap">
...
const urls = ["https://explained.meme/", "https://explained.meme/memes/", "https://explained.meme/meme-radar.html", "https://explained.meme/meme-generator.html", ...entries.map((entry) => `https://explained.meme/memes/${entry.slug}/`)];
