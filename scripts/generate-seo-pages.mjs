...
<body>
  ...
  <main class="wrap">
    ...
    <section class="related"><h2>Related meme explanations</h2><div class="related-grid">${related.map((item) => `<a href="../${item.slug}/">${escapeHtml(item.title)} →</a>`).join("")}</div></section>
  </main>
