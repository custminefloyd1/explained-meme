...
const checks=[
 ...
 ["speed choices",html.includes('value="8000"')&&html.includes('value="15000"')&&html.includes('value="30000"')],
 ...
 ["contextual voting links",html.includes("VOTE IN DAILY MEME BATTLE")&&html.includes("RATE IN CERTIFIED FUNNY")],
